...
"""
This module contains the argument manager class (ported minimal).
"""
...
from qs.exchanges.freqtrade_port.constants import DATETIME_PRINT_FORMAT
from qs.exchanges.freqtrade_port.exceptions import ConfigurationError
from qs.exchanges.freqtrade_port.util.datetime_helpers import dt_from_ts
...
class TimeRange:
    ...
    @classmethod
    def parse_timerange(cls, text: str | None) -> "TimeRange":
        """
