...
from qs.exchanges.freqtrade_port.configuration import TimeRange
...
from qs.exchanges.freqtrade_port.enums import CandleType, TradingMode
from qs.exchanges.freqtrade_port.exceptions import OperationalException
...
def trades_to_ohlcv(trades: DataFrame, timeframe: str) -> DataFrame:
    ...
    """
    from qs.exchanges.freqtrade_port.exchange import timeframe_to_resample_freq
...
def convert_trades_format(config: Config, convert_from: str, convert_to: str, erase: bool):
    ...
    if convert_from == "kraken_csv":
        ...
        from qs.exchanges.freqtrade_port.data.converter.trade_converter_kraken import import_kraken_trades_from_csv
