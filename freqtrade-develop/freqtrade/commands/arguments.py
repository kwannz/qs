...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        # Add data-quality subcommand
        data_quality_cmd = subparsers.add_parser(
            "data-quality",
            help="Scan local data for gaps/duplicates and optionally fix duplicates.",
            parents=[_common_parser],
        )
        data_quality_cmd.set_defaults(func=start_data_quality)
        self._build_args(optionlist=ARGS_DATA_QUALITY, parser=data_quality_cmd)
