    ...
    "properties": {
        ...
        "api_server": {
            ...
            "properties": {
                ...
                "auth_disabled": {
                    "description": "Disable API authentication for personal/local use (not recommended for public networks).",
                    "type": "boolean",
                    "default": False,
                },
                "roles": {
                    "description": "Optional role mapping for users (e.g. {'user': ['admin']}).",
                    "type": "object",
                    "additionalProperties": {
                        "type": "array",
                        "items": {"type": "string"},
                ...
                "rate_limit_per_minute": {
                    "description": "Private API rate limit per token/IP per minute.",
                    "type": "integer",
                    "minimum": 1,
                    "default": 120,
                },
                "rate_limit_backend": {
                    "description": "Rate limit backend (memory, redis, redis_sliding).",
                    "type": "string",
                    "enum": ["memory", "redis", "redis_sliding"],
                    "default": "memory",
                },
                ...
                "enable_rate_limit": {
                    "description": "Enable per-token/IP rate limit on private API.",
                    "type": "boolean",
                    "default": False,
                },
                "max_ws_connections": {
                ...
                "ws_max_messages_per_sec": {
                    "description": "Inbound WebSocket message rate limit (messages per second).",
                    "type": "integer",
                    "minimum": 1,
                    "default": 10,
                },
                "ws_max_message_bytes": {
                    "description": "Inbound WebSocket max message size in bytes.",
                    "type": "integer",
                    "minimum": 1024,
                    "default": 65536,
                },
    ...
    "definitions": {
        "exchange": {
            ...
            "properties": {
                ...
                "strict_futures_min_notional": {
                    "description": "Enforce futures min notional based on leverage tiers.",
                    "type": "boolean",
                    "default": False,
                },
                "outdated_offset": {
