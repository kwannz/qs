...
> We recommend running FreqUI/APIs bound to `127.0.0.1` on a trusted machine and not exposing them publicly. For remote/multi-user use, enable authentication (see rest-api.md), configure CORS, and consider Redis-backed rate limits.
